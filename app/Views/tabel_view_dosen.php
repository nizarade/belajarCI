...
<body>
    <div class="container">
        ...
        <div style="margin-bottom: 15px;">
            <a href="<?= site_url('dosen/create') ?>" style="background-color: #2ecc71; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px;">+ Tambah Dosen</a>
        </div>

        <?php if (!empty($dosen_data) && is_array($dosen_data)): // Cek apakah ada data dosen ?>
            <table>
                <thead>
                    <tr>
                        <th>NIM</th>
